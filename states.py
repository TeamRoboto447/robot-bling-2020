...
class init:
    def __init__(self, dictOfGroups, tables, pixels):
        ...
        self.pixels = pixels
    def start(self):
        self.dic["frame"].fillOverTime((0, 10, 0), numberPerLoop = 2)
        self.dic["turret"].fillOverTime((0, 10, 0), numberPerLoop = 2)
        self.dic["frame"].fillOverTime((55, 0, 55))
        self.dic["turret"].fillOverTime((55, 0, 55), numberPerLoop = 2)
        self.dic["frame"].fillOverTime((255, 255, 255), numberPerLoop = 2)
        self.dic["turret"].fillOverTime((255, 255, 255), numberPerLoop = 2)
    def run(self):
        pass
    end = end
